...
class CustomEditableText extends StatefulWidget {
  ...
  ///
  /// The cursor refers to the blinking caret when the [CustomEditableText] is focused.
  ///
  /// See also:
  ///
  ...
  ///
  /// The [CustomEditableText] widget used on its own will not trigger the display
  /// of the selection toolbar by itself. The toolbar is shown by calling
  /// [CustomEditableTextState.showToolbar] in response to an appropriate user event.
  ///
  /// See also:
  ///
  ///  * [CupertinoTextField], which wraps an [CustomEditableText] and which shows the
  ///    selection toolbar upon user events that are appropriate on the iOS
  ///    platform.
  ///  * [TextField], a Material Design themed wrapper of [CustomEditableText], which
  ...
  /// testing purposes.
  ///
  /// It does not affect the necessity to focus the CustomEditableText for the cursor
...
class CustomEditableTextState extends State<CustomEditableText>
  ...
  TextSpan buildTextSpan(SyntaxHighlighterStyle style) {
    if (widget.dartCode) {
      ...
      return TextSpan(
        ...
        children: <TextSpan>[DartSyntaxHighlighter(style).format(_value.text)],
      );
    }
